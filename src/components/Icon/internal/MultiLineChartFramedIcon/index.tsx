    ...
    case "line":
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <path
            fill={fill}
            d="M3,3h18a1,1,0,0,1,1,1v16a1,1,0,0,1-1,1h-18a1,1,0,0,1-1-1v-16A1,1,0,0,1,3,3Zm1,2v14h16v-14Z"
          />
          <path
            fill={fill}
            d="M13.468,12.046l-3.162-2.893-3.271,2.469-1.024-1.357,4.4-3.32,3.167,2.9,3.394-2.536,1.018,1.361Z"
          />
          <path
            fill={fill}
            d="M13.668,17.046l-3.162-2.893-3.271,2.469-1.024-1.357,4.4-3.32,3.167,2.9,3.394-2.536,1.018,1.361Z"
          />
        </svg>
      );
    case "fill":

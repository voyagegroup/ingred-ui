...
<Canvas>
  <Story name="info" args={{ appearance: "info" }}>
    {(args) => <Toast {...args}>{args.appearance}</Toast>}
  </Story>
  <Story name="success" args={{ appearance: "success" }}>
    {(args) => <Toast {...args}>{args.appearance}</Toast>}
  </Story>
  <Story name="warning" args={{ appearance: "warning" }}>
    {(args) => <Toast {...args}>{args.appearance}</Toast>}
  </Story>
  <Story name="error" args={{ appearance: "error" }}>
    {(args) => <Toast {...args}>{args.appearance}</Toast>}
  </Story>
</Canvas>

...
export type FullSizeModalCloseReason = "clickCloseIcon" | "clickCancelButton";
...
export type FullSizeModalProps = {
  title: string;
  confirmText?: string;
  cancelText?: string;
  onClose?: (
    event: React.MouseEvent<HTMLDivElement | HTMLButtonElement, MouseEvent>,
    reason: ModalCloseReason | FullSizeModalCloseReason,
  ) => void;
  /**
...
const FullSizeModal = React.forwardRef<HTMLDivElement, FullSizeModalProps>(
  (inProps, ref) => {
    ...
    const handleClose =
      (reason: FullSizeModalCloseReason) =>
      (
        event: React.MouseEvent<HTMLDivElement | HTMLButtonElement, MouseEvent>,
      ) => {

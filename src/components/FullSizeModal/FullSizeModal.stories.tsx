...
import FullSizeModal, { FullSizeModalProps } from "./FullSizeModal";
...
export default {
  title: "Components/Utils/FullSizeModal",
...
const Template: Story<FullSizeModalProps> = (args) => {
  ...
  return (
    <>
      ...
      <FullSizeModal onClose={handleToggleButton} {...args} isOpen={isOpen}>
        {args.children}
      </FullSizeModal>
    </>
  );
